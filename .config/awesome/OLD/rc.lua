...
-- local function run_once(cmd_arr) -- THE NOTER.
...
local editor = os.getenv("EDITOR") or terminal("-e ")("nvim")

-- awesome variables
awful.util.terminal = terminal
--awful.util.tagnames = {  "    ", "   ", "   ", "   ", "   ", "   ", "   ", "   ", "    " } --Noto Sans 12ish
--awful.util.tagnames = { " DEV ", " WWW ", " CHAT ", " DOC ", " GFX ", " SYS ", " MUS ", " VID ", " VBOX " }
--awful.util.tagnames = { " DEV ", " WWW ", " DOC ", " GFX ", " SYS ", " CHAT ", " MUS ", " VID ", " VBOX " }
...
--]]
	-- Tag browsing alt + tab and modkey + tab
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey,  }, "l",
        ...
        awful.key({ modkey,  }, "Down",
            function()
                awful.client.focus.bydirection("down", c, true)
                if client.focus then client.focus:raise() end
            end,
            {description = "focus down", group = "client"}),
        awful.key({ modkey,  }, "Up",
...
-- focus window when mouse hovers over it (raise window = false)
